...
static const _Image_type_support_symbol_names_t _Image_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, hololens_msgs, msg, Image)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, hololens_msgs, msg, Image)),
  }
};
...
{
  return &::hololens_msgs::msg::rosidl_typesupport_cpp::Image_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, hololens_msgs, msg, Image)() {
  return get_message_type_support_handle<hololens_msgs::msg::Image>();
}
