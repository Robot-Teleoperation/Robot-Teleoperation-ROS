...
#include "hololens_msgs/msg/detail/image__rosidl_typesupport_fastrtps_c.h"
...
using _Image__ros_msg_type = hololens_msgs__msg__Image;
...
size_t get_serialized_size_hololens_msgs__msg__Image(
  const void * untyped_ros_message,
...
static uint32_t _Image__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_hololens_msgs__msg__Image(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_hololens_msgs
size_t max_serialized_size_hololens_msgs__msg__Image(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_hololens_msgs__msg__Image(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, hololens_msgs, msg, Image)() {
