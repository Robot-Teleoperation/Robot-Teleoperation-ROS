...
static const _Image_type_support_symbol_names_t _Image_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, hololens_msgs, msg, Image)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, hololens_msgs, msg, Image)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, hololens_msgs, msg, Image)() {
  return &::hololens_msgs::msg::rosidl_typesupport_c::Image_message_type_support_handle;
}
