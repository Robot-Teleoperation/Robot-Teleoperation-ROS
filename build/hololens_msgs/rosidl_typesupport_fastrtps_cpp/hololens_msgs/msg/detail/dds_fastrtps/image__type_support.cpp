...
#include "hololens_msgs/msg/detail/image__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const hololens_msgs::msg::Image & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  hololens_msgs::msg::Image & ros_message)
{
  // Member: data
  {
    cdr >> ros_message.data;
...
{
  auto typed_message =
    static_cast<const hololens_msgs::msg::Image *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<hololens_msgs::msg::Image *>(
    untyped_ros_message);
...
static size_t _Image__max_serialized_size(bool & full_bounded)
{
...
{
  return &hololens_msgs::msg::typesupport_fastrtps_cpp::_Image__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, hololens_msgs, msg, Image)() {
  return &hololens_msgs::msg::typesupport_fastrtps_cpp::_Image__handle;
}
