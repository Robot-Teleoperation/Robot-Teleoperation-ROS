...
#include <stddef.h>
#include "hololens_msgs/msg/detail/image__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  hololens_msgs__msg__Image__init(message_memory);
}

void Image__rosidl_typesupport_introspection_c__Image_fini_function(void * message_memory)
{
  hololens_msgs__msg__Image__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember Image__rosidl_typesupport_introspection_c__Image_message_member_array[3] = {
  {
    "data",  // name
    ...
    offsetof(hololens_msgs__msg__Image, data),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(hololens_msgs__msg__Image, width),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(hololens_msgs__msg__Image, height),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Image__rosidl_typesupport_introspection_c__Image_message_members = {
  ...
  "Image",  // message name
  3,  // number of fields
  sizeof(hololens_msgs__msg__Image),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, hololens_msgs, msg, Image)() {
