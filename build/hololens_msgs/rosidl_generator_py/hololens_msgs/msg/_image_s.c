...
bool hololens_msgs__msg__image__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("hololens_msgs.msg._image.Image", full_classname_dest, 30) == 0);
  }
  hololens_msgs__msg__Image * ros_message = _ros_message;
  {  // data
...
PyObject * hololens_msgs__msg__image__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("hololens_msgs.msg._image");
