...
static const ::rosidl_typesupport_introspection_cpp::MessageMember GetAIData_Request_message_member_array[2] = {
  {
    "point_x",  // name
    ...
    offsetof(hololens_msgs::srv::GetAIData_Request, point_x),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(hololens_msgs::srv::GetAIData_Request, point_y),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
size_t size_function__GetAIData_Response__scene_names(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<std::string> *>(untyped_member);
  return member->size();
}

const void * get_const_function__GetAIData_Response__scene_names(const void * untyped_member, size_t index)
{
  const auto & member =
...
void * get_function__GetAIData_Response__scene_names(void * untyped_member, size_t index)
{
  auto & member =
...
void resize_function__GetAIData_Response__scene_names(void * untyped_member, size_t size)
{
  auto * member =
    reinterpret_cast<std::vector<std::string> *>(untyped_member);
  member->resize(size);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember GetAIData_Response_message_member_array[1] = {
  {
    "scene_names",  // name
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(hololens_msgs::srv::GetAIData_Response, scene_names),  // bytes offset in struct
    nullptr,  // default value
    size_function__GetAIData_Response__scene_names,  // size() function pointer
    get_const_function__GetAIData_Response__scene_names,  // get_const(index) function pointer
    get_function__GetAIData_Response__scene_names,  // get(index) function pointer
    resize_function__GetAIData_Response__scene_names  // resize(index) function pointer
  }
};
