...
static rosidl_typesupport_introspection_c__MessageMember GetAIData_Request__rosidl_typesupport_introspection_c__GetAIData_Request_message_member_array[2] = {
  {
    "point_x",  // name
    ...
    offsetof(hololens_msgs__srv__GetAIData_Request, point_x),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(hololens_msgs__srv__GetAIData_Request, point_y),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static rosidl_typesupport_introspection_c__MessageMember GetAIData_Response__rosidl_typesupport_introspection_c__GetAIData_Response_message_member_array[1] = {
  {
    "scene_names",  // name
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(hololens_msgs__srv__GetAIData_Response, scene_names),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
